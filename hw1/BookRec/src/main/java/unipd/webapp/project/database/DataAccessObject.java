 ...
 * unipd.webapp.project.database, while the {@link #getOutputParam()} allows for retrieving any output parameters resulting from the access,
 * if any.
 *
...
public interface DataAccessObject<T> {
	...
	/**
	 * Accesses the unipd.webapp.project.database.
	 *
